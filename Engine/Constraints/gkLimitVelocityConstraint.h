...
-------------------------------------------------------------------------------
*/
#ifndef _gkLimitVelocityConstraint_h_
#define _gkLimitVelocityConstraint_h_

#include "gkConstraint.h"


class gkLimitVelocityConstraint : public gkConstraint
{
public:
...
#endif//_gkLimitVelocityConstraint_h_
