...
bool gkWindowNaCl::setupInput(const gkUserDefs& prefs)
{
	// OIS
	try
	{
...
void gkWindowNaCl::dispatch(void)
{
	//GK_ASSERT(m_itouch);
...
void gkWindowNaCl::process(void)
{
...
void gkWindowNaCl::transformInputState(OIS::MultiTouchState& state)
{
...
bool gkWindowNaCl::touchPressed(const OIS::MultiTouchEvent& arg)
{
...
bool gkWindowNaCl::touchReleased(const OIS::MultiTouchEvent& arg)
{
	gkMouse& data = m_mouse;
...
bool gkWindowNaCl::touchMoved(const OIS::MultiTouchEvent& arg)
{
	gkMouse& data = m_mouse;
	OIS::MultiTouchState state = arg.state;;
...
bool gkWindowNaCl::axisMoved( const OIS::JoyStickEvent &arg, int axis ){
...
bool gkWindowNaCl::touchCancelled(const OIS::MultiTouchEvent& arg)
{
	return true;
}
