...
#ifndef _gkParticleEmitter_h_
#define _gkParticleEmitter_h_
...
class gkParticleEmitter : public Ogre::ParticleEmitter
{
protected:
...
public:
	...
	gkParticleEmitter(Ogre::ParticleSystem* psys);
	virtual ~gkParticleEmitter();
...
class gkEmitterFactory : public Ogre::ParticleEmitterFactory
{
public:	
	GK_INLINE Ogre::String getName() const { return gkParticleEmitter::NAME; }
	Ogre::ParticleEmitter* createEmitter(Ogre::ParticleSystem* psys);
};

#endif//_gkParticleEmitter_h_