...
#ifndef GKACTUATORSENSOR_H
#define GKACTUATORSENSOR_H

#include "gkLogicSensor.h"

class gkActuatorSensor : public gkLogicSensor
{
private:
...
public:
	...
	GK_INLINE const gkString& getActuatorName(void)              const { return m_actuatorName;}
};
