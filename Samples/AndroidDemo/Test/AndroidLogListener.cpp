...
#define  LOG_TAG    "ogre"
#define  LOGI(...)  printf//__android_log_print(ANDROID_LOG_INFO,LOG_TAG,__VA_ARGS__)
#define  LOGE(...)  printf//__android_log_print(ANDROID_LOG_ERROR,LOG_TAG,__VA_ARGS__)
