...
#define WXWIN_OS_DESCRIPTION "Linux 2.6.31-14-generic x86_64"
...
#cmakedefine wxSIZE_T_IS_UINT @wxSIZE_T_IS_UINT@

/* Define if size_t on your machine is the same type as unsigned long. */
#cmakedefine wxSIZE_T_IS_ULONG @wxSIZE_T_IS_ULONG@
#endif
