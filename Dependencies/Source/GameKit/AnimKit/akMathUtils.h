...
UT_INLINE akScalar akAbs(const akScalar& v)                                          { return v < 0.0 ? -v : v; }
UT_INLINE akScalar akClampf(const akScalar& v, const akScalar& a, const akScalar& b) { return v < a ? a : v > b ? b : v; }
UT_INLINE bool     akFuzzy(const akScalar& v)                                        { return akAbs(v) < AK_EPSILON;}
