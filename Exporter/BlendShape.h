...
public:
	...
	void extractBlendShape(MObject& DeformerObj);

	void outputBlendAnim(std::ostream& ofs, int startFrame, int endFrame, SBlendAnim* blendAnim);
