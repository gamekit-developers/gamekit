...
-------------------------------------------------------------------------------
*/
#ifndef _OgreStringDefines_h_
#define _OgreStringDefines_h_
...
#define OGRE_NullChar '\0'
#define OGRE_NullCharCheck(x) (!((x) && (x)[0] != OGRE_NullChar))

#define utALLOCPADDING 32

#endif//_OgreStringDefines_h_
